                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        ?>
                            ...
                            <tr class="<?= $warna; ?>">
                                ...
                                <td>
                                    <!-- Tombol Informasi -->
                                    <a style="color: white;" title="Informasi Riwayat Tagihan" href="index.php?p=tagihan-info-siswa&id_tagihan=<?= $kolom['id_tagihan']; ?>"><i class="fas fa-search"></i></a>
                                    &nbsp;
                                </td>
                            </tr>
                        <?php
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-hover table-md">
                        ...
                        bayar.dihapus_pada IS NULL AND bayar.id_siswa=siswa.id_siswa AND bayar.id_bayar_metode=bayar_metode.id_bayar_metode AND bayar.id_siswa=$id_siswa";
                        $query = mysqli_query($koneksi, $sql);
                        while ($kolom = mysqli_fetch_array($query)) {
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- Tombol Informasi -->
                                    <a title="Informasi Riwayat Tagihan" href="index.php?p=bayar-alokasi-siswa&id_bayar=<?= $kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a>
                                    &nbsp;
                                </td>
                            </tr>
                        <?php } ?>
