            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="aksi/tagihan.php" method="post">
                        ...
                        <input type="date" class="form-control" name="tanggal_jatuh_tempo" <?php if($tagihan['total_terbayar']>0){
                        ?> readonly <?php } ?> value="<?= $tagihan['tanggal_jatuh_tempo']; ?>">

                        <div class="row">
                            <div class="col-md-4">
                                <label for="siswa">Total Tagihan</label>
                                <input type="number" class="form-control text-right" name="jumlah_biaya"
