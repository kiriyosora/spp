            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php?p=bayar">Riwayat Tagihan dan Pembayaran</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="aksi/bayar.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" name="nominal_bayar" class="form-control text-right111111" readonly value="<?= $bayar['nominal_bayar'] ?>">
                            </div>
                        </div>
                    </form>
                </div>
