...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Informasi Riwayat Transaksi Pembayaran</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php?p=tagihan">Riwayat Tagihan dan Pembayaran</a></li>
                            ...
                            while ($bayar_alokasi = mysqli_fetch_array($query)) {
                                echo "
                                    <tr>
                                        ...
                                        <td><a href='index.php?p=bayar-alokasi&id_bayar=$bayar_alokasi[id_bayar]' target='blank' title='Lihat foto bukti'>#$bayar_alokasi[id_bayar]</a> | <a href='file/buktibayar/$bayar_alokasi[bukti_bayar]' target='blank' title='Lihat foto bukti'><i class='fas fa-image'></i></a></td>
