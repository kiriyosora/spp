    ...
    <div class="container-fluid">
      <div class="card">
        ...
        <div class="card-body">
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <!-- Tombol Hapus -->
                  <a onclick="return confirm('Yakin mau hapus data ?')" href="aksi/periode.php?aksi=hapus&id_periode=<?= $kolom['id_periode']; ?>"><i class="fas fa-trash"></a></i>
                </td>
              </tr>
              <!-- Modal Ubah Periode -->
          ...
          <button type="button" class="btn bg-dark btn-block mt-3" data-toggle="modal" data-target="#modalTambah"><i class="fas fa-plus"></i> Tambah Periode Baru</button>
        ...
        <table class="table table-hover">
          ...
          ?>
            ...
            <tr>
              ...
              <td> <a onclick="return confirm('Restore data kembali?')" href="aksi/periode.php?aksi=restore&id_periode=<?= $kolom['id_periode']; ?>"><i class="fas fa-trash-restore"></i></a>|<a onclick="return confirm('Yakin mau hapus permanen?')" href="aksi/periode.php?aksi=hapus-permanen&id_periode=<?= $kolom['id_periode']; ?>"><i class="fas fa-eraser"></i></a></td>
            </tr>
          <?php
          } // akhir while
          ?>
