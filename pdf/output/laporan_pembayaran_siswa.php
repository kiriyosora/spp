...
$pdf->setAuthor('Sora Rayosdelsol');
...
$html = '
<p align="center"><stong><bold>Laporan Pembayaran Siswa</strong></b></p><br>
<br>Periode : '.date('d-F-Y',strtotime($tanggal_awal)). ' S/D '. date('d-F-Y',strtotime($tanggal_akhir)).'</br><br><br>
...
$pdf->Output('laporan_peserta_didik.php', 'I');
