...
if ($_POST) {
    if ($_POST['aksi'] == 'tambah') { // untuk manajemen
        ...
        $nama_file_bukti = $date . "_" . $_FILES['bukti_bayar']['name'];
        $posisi_file_bukti = $_FILES['bukti_bayar']['tmp_name'];
        ...
        $sql = "INSERT INTO bayar (id_bayar,id_siswa,id_bayar_metode,keterangan,bukti_bayar,status_verifikasi,nominal_bayar,tanggal_bayar,dibuat_pada,diubah_pada,dihapus_pada) VALUES(DEFAULT,'$id_siswa','$id_bayar_metode','$keterangan','$bukti','$status_verifikasi','$nominal_bayar','$tanggal_bayar',DEFAULT,DEFAULT,DEFAULT)";
    ...
    elseif ($_POST['aksi'] == 'tambah-siswa') { // untuk siswa
        $id_siswa = $_POST['id_siswa'];
        $id_bayar_metode = $_POST['id_bayar_metode'];
        $keterangan = $_POST['keterangan'];
        $status_verifikasi = "Belum Verifikasi";
        ...
        $sql = "UPDATE bayar SET id_siswa='$id_siswa', id_bayar_metode='$id_bayar_metode', keterangan='$keterangan', bukti='$bukti',status_verifikasi='$status_verifikasi', nominal_bayar='$nominal_bayar', tanggal_bayar='$tanggal_bayar' WHERE id_bayar=$id_bayar";
